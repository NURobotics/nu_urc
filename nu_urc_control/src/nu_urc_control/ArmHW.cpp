#include <nu_urc_control/ArmHW.h>
...
void ArmHW::init(hardware_interface::JointStateInterface& js_interface, 
...
void ArmHW::read(const sensor_msgs::JointState& j_state) {
...
void ArmHW::write(ros::Duration time_diff) {
